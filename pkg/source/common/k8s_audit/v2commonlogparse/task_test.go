...
// 		expectedResult  *types.AuditLogParserInput
// 		expectedErr     bool
...
// 			} else {
// 				if diff := cmp.Diff(tc.expectedResult, result, cmpopts.IgnoreFields(types.AuditLogParserInput{}, "Log")); diff != "" {
...
// 	res, err := testtask.RunSingleTask[[]*types.AuditLogParserInput](Task, task.TaskModeRun,
...
// 	}
// 	for _, r := range res {
// 		if diff := cmp.Diff(expectedResult, r, cmpopts.IgnoreFields(types.AuditLogParserInput{}, "Log")); diff != "" {
// 			t.Errorf("the result is not valid:\n%s", diff)
// 		}
// 	}
// }
