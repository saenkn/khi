...
func recordChangeSetForLog(ctx context.Context, log *types.ResourceSpecificParserInput, prevEndpointSlices *model.EndpointSlice, cs *history.ChangeSet, builder *history.Builder) (*model.EndpointSlice, error) {
